...
uncertainty ({\textbf{???}}). In the wild, children pursue ways to
reduce uncertainty when faced with a possible reward ({\textbf{???}})
and search for additional information on a particular topic when their
intuitive theories are less informative ({\textbf{???}}). Thus, this
