...
```{r fig.env = "figure*", fig.pos = "H", fig.align='center', fig.width=2, fig.height=2, set.cap.width=T, num.cols.cap=1, fig.cap = "Experiment 1b. Proportion of correct responses across SNR levels from 5--25dB. Error bars show 95\\% confidence intervals."}
...
```{r fig.env = "figure", fig.pos = "H", fig.align='center', fig.width=2, fig.height=2, set.cap.width=T, num.cols.cap=1, fig.cap = "Experiment 1b. Proportion of correct responses across SNR levels from 5-25dB, split by children's age in years.", eval=FALSE}
