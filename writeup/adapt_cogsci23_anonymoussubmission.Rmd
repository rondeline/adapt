...
## x-axis labels
xlabels <- c("music", "5-talker babble", "silence", "white noise")
...
```{r e3-table, fig.pos = "t", fig.align='center'}
apa_table(summary_3b)
```
