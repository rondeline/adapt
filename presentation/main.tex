...
\institute[shortinst]{Department of Psychology, Stanford Universit\\Stanford, CA 94305 USA}
      ...
      \begin{tabular}{@{}p{0.45\linewidth}p{0.45\linewidth}@{}}
        \begin{minipage}[t]{\linewidth}
          \begin{itemize}
            \item Experiment 1
            \begin{itemize}
              \item N = 72 [$\mu$ = 4.46 years]
              \item African American/Black = 4.2\%
              \item Asian American/Pacific Islander = 23.6\%
              \item Caucasian/White = 27.8\%
              \item Hispanic/Latinx = 8.3\%
              \item Multiracial = 26.4\%
              \item Other = 8.3\%
            \end{itemize}
          \end{itemize}
        \end{minipage}
            ...
            \begin{itemize}
              ...
              \begin{minipage}[t]{0.45\linewidth}
                \begin{itemize}
                  \item Children
                  \begin{itemize}
                    \item N = 54 [$\mu$ = 4.55 years]
                    \item African American/Black = 3.7\%
                    \item Asian American/Pacific Islander = 37\%
                    \item Caucasian/White = 31.5\%
                    \item Hispanic/Latinx = 7.4\%
                    \item Multiracial = 20.4\%
                  \end{itemize}
                \end{itemize}
              \end{minipage}
              \begin{minipage}[t]{0.45\linewidth}
                \begin{itemize}
                  \item Adults
                  \begin{itemize}
                    \item N = 37 [$\mu$ = 40.43 years]
                    \item African American/Black = 4.2\%
                    \item Asian American/Pacific Islander =
                    \item Caucasian/White = 70.3%
  ...
  \begin{block}{test}
    ...
    \begin{table}
      ...
      \begin{tabular}{|X|X|X|X|}
        ...
        \midrule
        \centering
        \includegraphics[width=0.1\textwidth]{figures/dance.png} &
        \includegraphics[width=0.1\textwidth]{figures/read.png} &
        \includegraphics[width=0.1\textwidth]{figures/sleep.png} &
        \includegraphics[width=0.1\textwidth]{figures/talk.png} \\
        \bottomrule
      \end{tabular}
      \caption{Study 1 Stimuli}
    \end{table}
    ...
    \begin{table}
        ...
        \begin{tabular}{|X|X|X|X|}
          ...
          \textbf{Terb} \\
          \midrule
          \includegraphics[width=0.1\textwidth]{figures/fraw.png} & 
          \includegraphics[width=0.1\textwidth]{figures/gobb.png} & 
          \includegraphics[width=0.1\textwidth]{figures/plip.png} & 
          \includegraphics[width=0.1\textwidth]{figures/terb.png} \\
          \bottomrule
        \end{tabular}
        \caption{Study 2 Stimuli}
      \end{table}
  
      \begin{figure}
        \includegraphics[width = 6in, height = 4in]{../writeup/figs/e3-stimuli-1.pdf}
      \end{figure}
