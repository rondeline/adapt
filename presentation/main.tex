...
\begin{column}{\colwidth}
  ...
  \begin{block}{Background}
    ...
    \begin{itemize}
      \item \textbf{Children as flexible learners} risus nulla, sed ornare
      \item \textbf{Background noise} a duis congue vitae
      \item \textbf{(Ecological) Active learning} morbi justo neque, ullamcorper
      \item \textbf{Environmental selection} morbi justo neque, ullamcorper
    \end{itemize}    
  ...
  \begin{alertblock}{A highlighted block}
    ...
    To what extent do preschool children use environmental selection as an
    adaptive strategy for learning in noisy acoustic environments?
