...
\institute[shortinst]{\inst{1} Department of Psychology, Stanford University \begin Stanford, CA 94305 USA \end}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Methods}
    ...
    \begin{table}
      ...
      \begin{tabular}{c | c}
        \toprule
        \textbf{Activity} & \textbf{Label} \\
        \midrule
        \centering
        \includegraphics[width=0.1\textwidth]{figures/dance.png} & Dance \\
        \includegraphics[width=0.1\textwidth]{figures/read.png} & Read \\
        \includegraphics[width=0.1\textwidth]{figures/sleep.png} & Sleep \\
        \includegraphics[width=0.1\textwidth]{figures/talk.png} & Talk \\
        \bottomrule
      \end{tabular}
    ...
    \begin{table}
      \centering
      \large
      \begin{tabular}{\textwidth}{|p{2in}|X|X|X|X|}
        \toprule
        \adjustbox{valign=c}{\textbf{Fraw}} &
        \adjustbox{valign=c}{\textbf{Gobb}} &
        \adjustbox{valign=c}{\textbf{Plip}} & 
        \adjustbox{valign=c}{\textbf{Terb}} \\
        \midrule
        \adjustbox{valign=m}{\includegraphics[width=0.1\textwidth]{figures/fraw.png}} & 
        \adjustbox{valign=m}{\includegraphics[width=0.1\textwidth]{figures/gobb.png}} & 
        \adjustbox{valign=m}{\includegraphics[width=0.1\textwidth]{figures/plip.png}} & 
        \adjustbox{valign=m}{\includegraphics[width=0.1\textwidth]{figures/terb.png}} \\
        \centering Story before bed & \centering Something to do & \centering Spin to the beat & \centering Hide tummy rumbling \\
        \bottomrule
      \end{tabular}
      \caption{A table caption.}
    \end{table}
